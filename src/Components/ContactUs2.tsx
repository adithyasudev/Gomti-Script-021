      ...
      <div style={{ height:'auto'}}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap', height: 'auto' ,flexDirection:'row',marginLeft:'2vw'}}>
          <div style={{display:'flex' ,flexDirection:'column'}}>
            ...
            <br />
            <p style={{ fontSize: 'clamp(14px, 1.5vw, 15px)' }}>For detailed addresses and specific contact information of each office, we invite you to<br /> reach out directly to our team.</p>
          </div>
          <div>
