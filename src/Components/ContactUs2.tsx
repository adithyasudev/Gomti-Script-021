...
export const ContactUs2 = () => {
  return (
    ...
    <h1 style={{marginLeft:'12%',fontSize:'70px'}}>Contact Us</h1>
      ...
      <div style={{display:'flex',justifyContent:'space-evenly',flexWrap:'wrap',height:'30vh'}}>

      <div >
           <Bluebox />
        
          <p style={{fontSize:'30px',}}> <span style={{color: 'blue',fontSize:'35px' }}>ConvexTech Inc.</span> is proud to operate with a globally distributed team, ensuring a diverse
