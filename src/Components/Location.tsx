...
export const Location = () => {
  ...
  <Card style={{width:'25vw',backgroundColor:'#fafafa',border:'1px solid',borderRadius:'6px',display:'flex',flexDirection:'column',justifyContent:'space-between',alignItems:'center'}}>
    <CardHeader>
